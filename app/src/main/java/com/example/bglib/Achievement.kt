...
class Achievement (
    ...
    val requirements: List<() -> Boolean>,              // List of requirements of availability or because the achievement requires it
    val conditions: List<() -> Boolean>,                // List of conditions of the achievement (eg. is player using weapon x?)
    val multiplier: Int,                                // How many times should the trigger be triggered in order to unlock the achievement
