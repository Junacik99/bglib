...
class HandLandmarkerHelper(
    ...
    init {
        setupHandLandmarker()
        Log.d("OCVSample::Activity", "setting up")
    }
    ...
    fun detectLiveStream(
        ...
        Log.d("HandDetection", "bitmapBuffer: ${bitmapBuffer.height} x ${bitmapBuffer.width}")
        val proxyBuffer = imageProxy.planes[0].buffer
        proxyBuffer.rewind()
        Log.d("HandDetection", "imageProxy buffer: $proxyBuffer")
        Log.d("HandDetection", "Bitmap bytes: ${bitmapBuffer.byteCount}")
        Log.d("HandDetection", "Bitmap resolution: ${bitmapBuffer.width} x ${bitmapBuffer.height}")
        imageProxy.use { bitmapBuffer.copyPixelsFromBuffer(proxyBuffer) }
        imageProxy.close()
